...
# у версії 3.1 файли зберігаються під іменами, які містять інформацію про факультет
# Деякі викладачі працюють і на факультеті, і в коледжі.
# Тому необхідно роаналізувати дані з обох сторінок - і на сайті ф-ту, і на сайті коледжу
